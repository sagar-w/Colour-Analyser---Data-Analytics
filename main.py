#                                                   DA mini project
#  Project name -    Colour Analyser
#  Guided by -       Prof. Milind Vaidya
#  Developed by -    (4266) Rushikesh Daulat pawar
#                    (4245) Sagar Siddharth Waghmare

import cv2
import pandas as pd

# Reading the image
img = cv2.imread(r'C:\Users\Rishi\PycharmProjects\colour Analyser\sample.jpg')
...
def selectColor(event, x, y, flag, param):
...
cv2.setMouseCallback('Sample', selectColor)
